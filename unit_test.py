...
class Tests(unittest.TestCase):
    ...
    def test_retrieve_Text_And_Image(self):
        ...
        self.coin_dict = web_Scraper._retrieve_Text_And_Image(coin_index)
    ...
    def test_saved_data(self):
        coin_index = random.randrange(0, 199) 
        self.directory = web_Scraper._save_data(coin_index)
        if(os.path.isdir('./raw_data/_/_.jpg') and os.path.isdir('./raw_data/_/_.json')):
            self.assertTrue
        else:
            self.assertFalse
